...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        % Top Flowchart (shifted left)
        \node[input, fill=blue!10] (input1) {Input};
        \node[process, right=0.8cm of input1, fill=blue!10] (featureextraction1) {Feature Extraction};
        \node[process, right=0.8cm of featureextraction1, fill=blue!10] (classification1) {Classification};
        \node[input, right=0.8cm of classification1, fill=blue!10] (output1) {Output};
        ...
        % Bottom Flowchart
        \node[input, below=1.3cm of input1, fill=blue!10] (input2) {Input};
        \node[process, right=1.3cm of input2, fill=blue!10] (combinedprocess) {Feature Extraction + Classification};
        \node[input, right=1.3cm of combinedprocess, fill=blue!10] (output2) {Output};
...
\subsubsection{Challenges}\label{subsubsec:data-challenges}
